    ...
    def __init__(self, transform=None, phase_train=True, data_dir=None):
        ...
        try:
            with open(img_dir_train_file, 'r') as f:
                self.img_dir_train = [element.strip() for element in f.read().splitlines()]
            with open(depth_dir_train_file, 'r') as f:
                self.depth_dir_train = [element.strip() for element in f.read().splitlines()]
            with open(label_dir_train_file, 'r') as f:
                self.label_dir_train = [element.strip() for element in f.read().splitlines()]
            with open(img_dir_test_file, 'r') as f:
                self.img_dir_test = [element.strip() for element in f.read().splitlines()]
            with open(depth_dir_test_file, 'r') as f:
                self.depth_dir_test = [element.strip() for element in f.read().splitlines()]
            with open(label_dir_test_file, 'r') as f:
                self.label_dir_test = [element.strip() for element in f.read().splitlines()]
        except:
            if data_dir is None:
