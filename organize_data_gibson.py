...
if __name__=='__main__':
    ...
    data_dir = 'data/gibson_data/gibson_training_data'
    rgb_dir = 'data/gibson_data/rgb'
    depth_dir = 'data/gibson_data/depth'
    label_dir = 'data/gibson_data/label'
    
    # adopting the way done in Rednet
    train_rgb_filepath = 'data/gibson_data/img_dir_train.txt'
    train_depth_filepath = 'data/gibson_data/depth_dir_train.txt'
    train_labels_filepath = 'data/gibson_data/label_train.txt'
    
    test_rgb_filepath = 'data/gibson_data/img_dir_test.txt'
    test_depth_filepath = 'data/gibson_data/depth_dir_test.txt'
    test_labels_filepath = 'data/gibson_data/label_test.txt'
