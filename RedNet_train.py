...
def train():
    ...
    print("creating data loader...") # ian
    ...
    if args.last_ckpt:
        ...
        model = RedNet_model.RedNet(num_classes=NUM_CLASSES, pretrained=True)
    print("done.")
    ...
    for epoch in range(int(args.start_epoch), args.epochs): # ian
